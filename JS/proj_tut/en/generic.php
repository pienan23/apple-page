			...
			<div id="wrapper">
                ...
                <header id="header" class="alt">
                    ...
                    <div class="langue" style="font-size: 12px; margin-top: 15px; margin-left: 800px;">
                        ...
                        <a href="generic.php" class="button" style="height: 30px;"><p>English</p></a>
                    </div>
                    <nav>
                        <a href="#menu">Menu</a>
                    </nav>
				...
				<!-- Main -->
					...
					<section style="margin-left: 55px; margin-right:55px;">
                        <h5 style="float:right; font-size:20px; text-decoration:underline dashed; margin-top:15px;";> <a href="admin.php">List of students</a></ h5>
                        <h1 style="text-align:center;">Registrations</h1>
                        <form method="POST" action="generic.php">
                            <div class="fields">
                                ...
                                <div class="field half">
                                    <label for="PRENOMS">First names</label>
                                    <input type="text" name="PRENOMS" id="firstname" />
                                </div>
                                <div class="field half">
...
width: 100%;" type="date" name="DATE_NAISS" id="date"/>
                                ...
                                <div class="field half">
                                    <label for="NUMERO_TEL">Telephone number</label>
                                ...
                                <div class="field half">
                                    ...
                                    <select style="background-color: -moz-appearance: none;-webkit-appearance: none;-ms-appearance: none; appearance: none; background: rgba(212, 212, 255, 0.035); border: none ;border-radius: 0;color: inherit;display: block;line-height: 48px;outline: 0;padding: 0 1em;text-decoration: none;width: 100%;" type="select" name="NIVEAU" id="level" >
                                        <option selected value="">--</option>
                                ...
                                <div class="field half">
                                    <label for="FILIERE">Subsector</label>
                            ...
                            <ul class="actions">
                                <li><input type="submit" value="SUBMIT" class="primary" name="benrg";/></li>
