...
<div id="wrapper">
    ...
    <header id="header" class="alt">
        <a href="index.html" class="logo"><strong>UTT-LOKO</strong> <span>l'expérience fait la différence</span></a>
        <div class="langue">
            <a href="#"><img style="width:35px; line-height:9px;" src="images/fr.png" alt=""></a>
            <a href="#"><img style="width:35px; line-height:9px;" src="images/us.png" alt=""></a>
        </div>
        <nav>
            <a href="#menu">Menu</a>
        </nav>
    ...
    <nav id="menu">
        <ul class="links">
            ...
            <li><a href="generic.html">Emploi du temps</a></li>
            <li><a href="elements.php">Campus</a></li>
    ...
    <section style="margin-left: 55px; margin-right:55px;">
        <h1 style="text-align:center; margin-top: 150px;">Connexion au forum</h1>
        <form method="POST" action="connexionn.php">
            <div class="fields">
                ...
                <ul class="actions" style="margin-left: 55px;">
                    <li><a href="inscriptionn.php"><input type="button" value="S'inscrire" class="primary" /></a></li>
                    <li><input type="submit" value="Valider" class="primary" name="bcon";/></li>
