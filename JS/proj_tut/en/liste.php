...
<div id="wrapper">
    ...
    <header id="header">
        ...
        <div class="langue" style="font-size: 12px; margin-top: 15px; margin-left: 800px;">
            ...
            <a href="liste.php" class="button" style="height: 30px;"><p>English</p></a>
        </div>
        <nav>
            <a href="#menu">Menu</a>
        </nav>
    ...
    <section style="margin-top: 50px;" >
        ...
        <form method="post" action="chercher.php">
            <div class="rec" style="display: flex;">
                ...
                <input type="submit" value="Research" name="btnrecherche">
            </div>
        </form>

        <table style="text-align: center; margin-top: 50px;">
            <thead>
                <th style="text-align: center; font-size: 16px;">REG. NUMBER</th><th style="text-align: center; font-size: 16px;">FIRST NAME</th><th style="text-align: center; font-size: 16px;">LAST NAME</th><th style="text-align: center; font-size: 16px;">BIRTHDAY</th><th style="text-align: center; font-size: 16px;">MAIL</th><th style="text-align: center; font-size: 16px;">PHONE</th><th style="text-align: center; font-size: 16px;">GENDER</th><th style="text-align: center; font-size: 16px;">LEVEL</th><th style="text-align: center; font-size: 16px;">COURSE</th><th style="text-align: center; font-size: 16px;">ACTIONS</th>
            </thead>
